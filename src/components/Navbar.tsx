        ...
        <header className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-slate-950 border-b-2 border-slate-200 dark:border-slate-800">
            <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
                ...
                <Link href="/" className="flex items-center gap-2 group">
                    ...
                    <span className="font-heading font-black text-2xl tracking-tighter text-slate-900 dark:text-slate-300">
                ...
                <div className="flex items-center gap-4">
                    <form onSubmit={handleSearch} className="hidden md:flex relative group">
                        <input
                            ...
                            className="bg-slate-100 dark:bg-slate-900 border border-transparent focus:border-blue-500 rounded-2xl px-5 py-2.5 text-sm w-48 focus:w-64 transition-all outline-none font-semibold text-slate-900 dark:text-slate-300"
                        />
